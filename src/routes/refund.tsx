...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Refund Policy — Leadora" },
      { name: "description", content: "Refund policy for Leadora subscription plans." },
      { property: "og:title", content: "Refund Policy — Leadora" },
      { property: "og:description", content: "Learn about Leadora's refund terms for monthly, yearly, and trial plans." },
      { property: "og:url", content: "https://mapseeker-spark.lovable.app/refund" },
    ],
    links: [{ rel: "canonical", href: "https://mapseeker-spark.lovable.app/refund" }],
  }),
        ...
        <section className="mt-10 space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              <a className="text-primary" href="mailto:support@leadora.io">support@leadora.io</a>.
            </p>
          </div>
