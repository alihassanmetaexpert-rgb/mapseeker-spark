...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — Leadora" },
      { name: "description", content: "Simple, transparent pricing for Leadora. Start free, upgrade as you scale your lead generation." },
      { property: "og:title", content: "Leadora Pricing — Plans for every team" },
      { property: "og:description", content: "Free trial, Basic, Pro, and Agency plans. Save 20% with yearly billing." },
      { property: "og:url", content: "https://mapseeker-spark.lovable.app/pricing" },
    ],
    links: [{ rel: "canonical", href: "https://mapseeker-spark.lovable.app/pricing" }],
  }),
