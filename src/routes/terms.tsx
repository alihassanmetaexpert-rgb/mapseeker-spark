...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Leadora" },
      { name: "description", content: "Terms of Service for Leadora, a lead generation tool for Google Maps." },
      { property: "og:title", content: "Terms of Service — Leadora" },
      { property: "og:description", content: "The rules for using Leadora's lead generation service." },
      { property: "og:url", content: "https://mapseeker-spark.lovable.app/terms" },
    ],
    links: [{ rel: "canonical", href: "https://mapseeker-spark.lovable.app/terms" }],
  }),
  component: TermsPage,
});
      ...
      <article className="mx-auto max-w-3xl px-6 py-16 prose prose-neutral dark:prose-invert">
        ...
        <section className="mt-10 space-y-6 text-sm leading-relaxed text-muted-foreground">
          <div>
            ...
            <p className="mt-2">
              By accessing or using Leadora ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Leadora is a lead generation tool that helps users discover publicly available business information from Google Maps and export it to spreadsheets and Google Sheets.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              You agree not to use Leadora to: (a) violate any applicable law or third-party rights; (b) send unsolicited bulk communications in violation of anti-spam laws (CAN-SPAM, GDPR, CASL); (c) resell raw lead data without adding value; or (d) interfere with the Service's infrastructure.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Leadora and its branding are owned by us. You receive a limited, non-exclusive license to use the Service for its intended purpose during the term of your subscription.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              To the maximum extent permitted by law, Leadora shall not be liable for any indirect, incidental, or consequential damages arising from your use of the Service.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Questions? Email <a className="text-primary" href="mailto:support@leadora.app">support@leadora.app</a>.
            </p>
          </div>
        </section>
      </article>
