...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Leadora collects, uses, and protects your data, including Google OAuth and lead data storage." },
      { property: "og:title", content: "Privacy Policy — Leadora" },
      { property: "og:description", content: "How we handle your data, Google OAuth tokens, and the leads you generate." },
      { property: "og:url", content: "https://mapseeker-spark.lovable.app/privacy" },
    ],
    links: [{ rel: "canonical", href: "https://mapseeker-spark.lovable.app/privacy" }],
  }),
      ...
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="mt-10 space-y-6 text-sm leading-relaxed text-muted-foreground">
          <div>
            ...
            <p className="mt-2">
              We collect information you provide directly (account email, billing details), information generated as you use Leadora (search queries, scrape jobs, exported leads), and minimal technical data (IP address, browser type) needed to operate the Service.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Leadora's use and transfer of information received from Google APIs adheres to the{" "}
          ...
          <div>
            ...
            <p className="mt-2">Leadora is not directed to children under 16 and we do not knowingly collect their personal data.</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Privacy questions? Email <a className="text-primary" href="mailto:privacy@leadora.app">privacy@leadora.app</a>.
            </p>
          </div>
        </section>
      </article>
